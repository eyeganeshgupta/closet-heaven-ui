...
import { fetchOrdersStatsAction } from "../../../redux/slices/orders/ordersSlice";
...
export default function OrdersStats() {
  ...
  useEffect(() => {
    dispatch(fetchOrdersStatsAction());
  }, []);

  // TODO: get stats data from store
  const { loading, stats, error } = useSelector((state) => {
    return state?.orders;
  });

  const obj = stats?.salesStats;
  console.log(obj);
