                    ...
                    <tbody className="divide-y divide-gray-200 bg-white">
                      {coupons?.coupons?.map((coupon) => (
                        <tr key={coupon._id}>
                          ...
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                            {coupon?.isExpired ? (
                              <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-700 text-gray-100">
                                Expired
                              </span>
                            ) : (
                              <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-700 text-gray-100">
                                Active
                              </span>
                            )}
                          </td>
