...
export default function ProductsFilters() {
  ...
  }, [dispatch, category, size, color, brand, price]);
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {localStorage.getItem("userInfo") ? (
            <div className="mt-6 flex items-baseline justify-between border-b border-gray-200 pt-24 pb-6">
            ...
            <div className="mt-6 lg:mt-16 flex items-baseline justify-between border-b border-gray-200 pt-24 pb-6">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900">
                Product Filters
              </h1>
              {/* sort */}
