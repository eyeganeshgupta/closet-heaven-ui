...
export default function ShoppingCart() {
  ...
  // TODO: get coupon from store
  const { loading, coupon, error, isExists } = useSelector((state) => {
  ...
  // TODO: calculate total order summary
  sumTotalPrice = cartItems?.reduce((accumulator, current) => {
  ...
  const removeOrderItemFromCartHandler = (productId) => {
    dispatch(removeOrderFromCartAction(productId));
    dispatch(getCartItemsFromLocalStorageAction());
  };
        ...
        <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                    ...
                    <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                      ...
                      <div className="mt-4 sm:mt-0 sm:pr-9">
                        ...
                        <div className="absolute top-0 right-0">
                          <button
                            onClick={() =>
                              removeOrderItemFromCartHandler(product?._id)
                            }
          ...
          >
            ...
            <dl className="mt-6 space-y-4">
              ...
              {isExists && (
                <SuccessMsg
                  message={`Congratulations you got ${coupon?.coupon?.discount}% discount`}
                />
              )}
            ...
            <div className="mt-6">
              <Link
                // TODO: pass data to checkout page
                to="/order-payment"
                state={{
                  sumTotalPrice,
                }}
