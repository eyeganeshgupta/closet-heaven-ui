...
export default function Product() {
  ...
  // TODO: get productId from params
  const { id } = useParams();
  ...
  const addToCartHandler = () => {
    // TODO: checking if the product is already in cart
    if (productExists) {
      return Swal.fire({
        icon: "error",
        title: "Oops...!",
    ...
    // ? Cart order size and color validation
    // TODO: check if color selected
    if (selectedColor === "") {
      return Swal.fire({
        icon: "error",
        title: "Oops...!",
    ...
    dispatch(
      addOrderToCartAction({
        ...
        // TODO: adding product to cart with colour and size
        color: selectedColor,
        size: selectedSize,
